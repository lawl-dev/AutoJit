========================================================================
    DYNAMIC LINK LIBRARY: UnmanagedTestDll-Projektübersicht
========================================================================

Diese UnmanagedTestDll-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre UnmanagedTestDll-Anwendung besteht.


UnmanagedTestDll.vcxproj
...
UnmanagedTestDll.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen UnmanagedTestDll.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
