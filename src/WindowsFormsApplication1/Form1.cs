...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            var conversionBootStrapper = new ConversionBootStrapper();

            _autoitToCSharpConverter = conversionBootStrapper.GetInstance<IAutoitToCSharpConverter>();
        }
        ...
        private void OnChange1(object sender, EventArgs e) {
            ...
            try {
                ...
                textBox2.Text = _autoitToCSharpConverter.Convert( autoitScriptRootNode ).NormalizeWhitespace().ToFullString();
            }
            catch (Exception ex) {
