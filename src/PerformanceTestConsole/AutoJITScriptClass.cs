...
namespace AutoJITScript
{
    public class AutoJITScriptClass
    {
        ...
        Variant v_HGDI_ERROR = Variant.Create((object)null);
        Variant v_INVALID_HANDLE_VALUE = Variant.Create((object)null);
        Variant v_CLR_INVALID = Variant.Create((object)null);
        Variant v_NULL_BRUSH = Variant.Create((object)null);
        Variant v_NULL_PEN = Variant.Create((object)null);
        Variant v_BLACK_BRUSH = Variant.Create((object)null);
        Variant v_DKGRAY_BRUSH = Variant.Create((object)null);
        Variant v_DC_BRUSH = Variant.Create((object)null);
        Variant v_GRAY_BRUSH = Variant.Create((object)null);
        Variant v_HOLLOW_BRUSH = Variant.Create((object)null);
        Variant v_LTGRAY_BRUSH = Variant.Create((object)null);
        Variant v_WHITE_BRUSH = Variant.Create((object)null);
        Variant v_BLACK_PEN = Variant.Create((object)null);
        Variant v_DC_PEN = Variant.Create((object)null);
        Variant v_WHITE_PEN = Variant.Create((object)null);
        Variant v_ANSI_FIXED_FONT = Variant.Create((object)null);
        Variant v_ANSI_VAR_FONT = Variant.Create((object)null);
        Variant v_DEVICE_DEFAULT_FONT = Variant.Create((object)null);
        Variant v_DEFAULT_GUI_FONT = Variant.Create((object)null);
        Variant v_OEM_FIXED_FONT = Variant.Create((object)null);
        Variant v_SYSTEM_FONT = Variant.Create((object)null);
        Variant v_SYSTEM_FIXED_FONT = Variant.Create((object)null);
        Variant v_DEFAULT_PALETTE = Variant.Create((object)null);
        Variant v_MB_PRECOMPOSED = Variant.Create((object)null);
        Variant v_MB_COMPOSITE = Variant.Create((object)null);
        Variant v_MB_USEGLYPHCHARS = Variant.Create((object)null);
        Variant v_ULW_ALPHA = Variant.Create((object)null);
        Variant v_ULW_COLORKEY = Variant.Create((object)null);
        Variant v_ULW_OPAQUE = Variant.Create((object)null);
        Variant v_ULW_EX_NORESIZE = Variant.Create((object)null);
        Variant v_WH_CALLWNDPROC = Variant.Create((object)null);
        Variant v_WH_CALLWNDPROCRET = Variant.Create((object)null);
        Variant v_WH_CBT = Variant.Create((object)null);
        Variant v_WH_DEBUG = Variant.Create((object)null);
        Variant v_WH_FOREGROUNDIDLE = Variant.Create((object)null);
        Variant v_WH_GETMESSAGE = Variant.Create((object)null);
        Variant v_WH_JOURNALPLAYBACK = Variant.Create((object)null);
        Variant v_WH_JOURNALRECORD = Variant.Create((object)null);
        Variant v_WH_KEYBOARD = Variant.Create((object)null);
        Variant v_WH_KEYBOARD_LL = Variant.Create((object)null);
        Variant v_WH_MOUSE = Variant.Create((object)null);
        Variant v_WH_MOUSE_LL = Variant.Create((object)null);
        Variant v_WH_MSGFILTER = Variant.Create((object)null);
        Variant v_WH_SHELL = Variant.Create((object)null);
        Variant v_WH_SYSMSGFILTER = Variant.Create((object)null);
        Variant v_WPF_ASYNCWINDOWPLACEMENT = Variant.Create((object)null);
        Variant v_WPF_RESTORETOMAXIMIZED = Variant.Create((object)null);
        Variant v_WPF_SETMINPOSITION = Variant.Create((object)null);
        Variant v_KF_EXTENDED = Variant.Create((object)null);
        Variant v_KF_ALTDOWN = Variant.Create((object)null);
        Variant v_KF_UP = Variant.Create((object)null);
        Variant v_LLKHF_EXTENDED = Variant.Create((object)null);
        Variant v_LLKHF_INJECTED = Variant.Create((object)null);
        Variant v_LLKHF_ALTDOWN = Variant.Create((object)null);
        Variant v_LLKHF_UP = Variant.Create((object)null);
        Variant v_OFN_ALLOWMULTISELECT = Variant.Create((object)null);
        Variant v_OFN_CREATEPROMPT = Variant.Create((object)null);
        Variant v_OFN_DONTADDTORECENT = Variant.Create((object)null);
        Variant v_OFN_ENABLEHOOK = Variant.Create((object)null);
        Variant v_OFN_ENABLEINCLUDENOTIFY = Variant.Create((object)null);
        Variant v_OFN_ENABLESIZING = Variant.Create((object)null);
        Variant v_OFN_ENABLETEMPLATE = Variant.Create((object)null);
        Variant v_OFN_ENABLETEMPLATEHANDLE = Variant.Create((object)null);
        Variant v_OFN_EXPLORER = Variant.Create((object)null);
        Variant v_OFN_EXTENSIONDIFFERENT = Variant.Create((object)null);
        Variant v_OFN_FILEMUSTEXIST = Variant.Create((object)null);
        Variant v_OFN_FORCESHOWHIDDEN = Variant.Create((object)null);
        Variant v_OFN_HIDEREADONLY = Variant.Create((object)null);
        Variant v_OFN_LONGNAMES = Variant.Create((object)null);
        Variant v_OFN_NOCHANGEDIR = Variant.Create((object)null);
        Variant v_OFN_NODEREFERENCELINKS = Variant.Create((object)null);
        Variant v_OFN_NOLONGNAMES = Variant.Create((object)null);
        Variant v_OFN_NONETWORKBUTTON = Variant.Create((object)null);
        Variant v_OFN_NOREADONLYRETURN = Variant.Create((object)null);
        Variant v_OFN_NOTESTFILECREATE = Variant.Create((object)null);
        Variant v_OFN_NOVALIDATE = Variant.Create((object)null);
        Variant v_OFN_OVERWRITEPROMPT = Variant.Create((object)null);
        Variant v_OFN_PATHMUSTEXIST = Variant.Create((object)null);
        Variant v_OFN_READONLY = Variant.Create((object)null);
        Variant v_OFN_SHAREAWARE = Variant.Create((object)null);
        Variant v_OFN_SHOWHELP = Variant.Create((object)null);
        Variant v_OFN_EX_NOPLACESBAR = Variant.Create((object)null);
        Variant v_TMPF_FIXED_PITCH = Variant.Create((object)null);
        Variant v_TMPF_VECTOR = Variant.Create((object)null);
        Variant v_TMPF_TRUETYPE = Variant.Create((object)null);
        Variant v_TMPF_DEVICE = Variant.Create((object)null);
        Variant v_DUPLICATE_CLOSE_SOURCE = Variant.Create((object)null);
        Variant v_DUPLICATE_SAME_ACCESS = Variant.Create((object)null);
        Variant v_DI_MASK = Variant.Create((object)null);
        Variant v_DI_IMAGE = Variant.Create((object)null);
        Variant v_DI_NORMAL = Variant.Create((object)null);
        Variant v_DI_COMPAT = Variant.Create((object)null);
        Variant v_DI_DEFAULTSIZE = Variant.Create((object)null);
        Variant v_DI_NOMIRROR = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_ATTACHED_TO_DESKTOP = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_MULTI_DRIVER = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_PRIMARY_DEVICE = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_MIRRORING_DRIVER = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_VGA_COMPATIBLE = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_REMOVABLE = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_DISCONNECT = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_REMOTE = Variant.Create((object)null);
        Variant v_DISPLAY_DEVICE_MODESPRUNED = Variant.Create((object)null);
        Variant v_FLASHW_CAPTION = Variant.Create((object)null);
        Variant v_FLASHW_TRAY = Variant.Create((object)null);
        Variant v_FLASHW_TIMER = Variant.Create((object)null);
        Variant v_FLASHW_TIMERNOFG = Variant.Create((object)null);
        Variant v_FORMAT_MESSAGE_ALLOCATE_BUFFER = Variant.Create((object)null);
        Variant v_FORMAT_MESSAGE_IGNORE_INSERTS = Variant.Create((object)null);
        Variant v_FORMAT_MESSAGE_FROM_STRING = Variant.Create((object)null);
        Variant v_FORMAT_MESSAGE_FROM_HMODULE = Variant.Create((object)null);
        Variant v_FORMAT_MESSAGE_FROM_SYSTEM = Variant.Create((object)null);
        Variant v_FORMAT_MESSAGE_ARGUMENT_ARRAY = Variant.Create((object)null);
        Variant v_GW_HWNDFIRST = Variant.Create((object)null);
        Variant v_GW_HWNDLAST = Variant.Create((object)null);
        Variant v_GW_HWNDNEXT = Variant.Create((object)null);
        Variant v_GW_HWNDPREV = Variant.Create((object)null);
        Variant v_GW_OWNER = Variant.Create((object)null);
        Variant v_GW_CHILD = Variant.Create((object)null);
        Variant v_GW_ENABLEDPOPUP = Variant.Create((object)null);
        Variant v_GWL_WNDPROC = Variant.Create((object)null);
        Variant v_GWL_HINSTANCE = Variant.Create((object)null);
        Variant v_GWL_HWNDPARENT = Variant.Create((object)null);
        Variant v_GWL_ID = Variant.Create((object)null);
        Variant v_GWL_STYLE = Variant.Create((object)null);
        Variant v_GWL_EXSTYLE = Variant.Create((object)null);
        Variant v_GWL_USERDATA = Variant.Create((object)null);
        Variant v_STD_CUT = Variant.Create((object)null);
        Variant v_STD_COPY = Variant.Create((object)null);
        Variant v_STD_PASTE = Variant.Create((object)null);
        Variant v_STD_UNDO = Variant.Create((object)null);
        Variant v_STD_REDOW = Variant.Create((object)null);
        Variant v_STD_DELETE = Variant.Create((object)null);
        Variant v_STD_FILENEW = Variant.Create((object)null);
        Variant v_STD_FILEOPEN = Variant.Create((object)null);
        Variant v_STD_FILESAVE = Variant.Create((object)null);
        Variant v_STD_PRINTPRE = Variant.Create((object)null);
        Variant v_STD_PROPERTIES = Variant.Create((object)null);
        Variant v_STD_HELP = Variant.Create((object)null);
        Variant v_STD_FIND = Variant.Create((object)null);
        Variant v_STD_REPLACE = Variant.Create((object)null);
        Variant v_STD_PRINT = Variant.Create((object)null);
        Variant v_IMAGE_BITMAP = Variant.Create((object)null);
        Variant v_IMAGE_ICON = Variant.Create((object)null);
        Variant v_IMAGE_CURSOR = Variant.Create((object)null);
        Variant v_IMAGE_ENHMETAFILE = Variant.Create((object)null);
        Variant v_KB_SENDSPECIAL = Variant.Create((object)null);
        Variant v_KB_SENDRAW = Variant.Create((object)null);
        Variant v_KB_CAPSOFF = Variant.Create((object)null);
        Variant v_KB_CAPSON = Variant.Create((object)null);
        Variant v_DONT_RESOLVE_DLL_REFERENCES = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_AS_DATAFILE = Variant.Create((object)null);
        Variant v_LOAD_WITH_ALTERED_SEARCH_PATH = Variant.Create((object)null);
        Variant v_LOAD_IGNORE_CODE_AUTHZ_LEVEL = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_AS_DATAFILE_EXCLUSIVE = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_AS_IMAGE_RESOURCE = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_SEARCH_APPLICATION_DIR = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_SEARCH_DEFAULT_DIRS = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_SEARCH_SYSTEM32 = Variant.Create((object)null);
        Variant v_LOAD_LIBRARY_SEARCH_USER_DIRS = Variant.Create((object)null);
        Variant v_S_OK = Variant.Create((object)null);
        Variant v_E_ABORT = Variant.Create((object)null);
        Variant v_E_ACCESSDENIED = Variant.Create((object)null);
        Variant v_E_FAIL = Variant.Create((object)null);
        Variant v_E_HANDLE = Variant.Create((object)null);
        Variant v_E_INVALIDARG = Variant.Create((object)null);
        Variant v_E_NOINTERFACE = Variant.Create((object)null);
        Variant v_E_NOTIMPL = Variant.Create((object)null);
        Variant v_E_OUTOFMEMORY = Variant.Create((object)null);
        Variant v_E_POINTER = Variant.Create((object)null);
        Variant v_E_UNEXPECTED = Variant.Create((object)null);
        Variant v_LR_DEFAULTCOLOR = Variant.Create((object)null);
        Variant v_LR_MONOCHROME = Variant.Create((object)null);
        Variant v_LR_COLOR = Variant.Create((object)null);
        Variant v_LR_COPYRETURNORG = Variant.Create((object)null);
        Variant v_LR_COPYDELETEORG = Variant.Create((object)null);
        Variant v_LR_LOADFROMFILE = Variant.Create((object)null);
        Variant v_LR_LOADTRANSPARENT = Variant.Create((object)null);
        Variant v_LR_DEFAULTSIZE = Variant.Create((object)null);
        Variant v_LR_VGACOLOR = Variant.Create((object)null);
        Variant v_LR_LOADMAP3DCOLORS = Variant.Create((object)null);
        Variant v_LR_CREATEDIBSECTION = Variant.Create((object)null);
        Variant v_LR_COPYFROMRESOURCE = Variant.Create((object)null);
        Variant v_LR_SHARED = Variant.Create((object)null);
        Variant v_OBM_TRTYPE = Variant.Create((object)null);
        Variant v_OBM_LFARROWI = Variant.Create((object)null);
        Variant v_OBM_RGARROWI = Variant.Create((object)null);
        Variant v_OBM_DNARROWI = Variant.Create((object)null);
        Variant v_OBM_UPARROWI = Variant.Create((object)null);
        Variant v_OBM_COMBO = Variant.Create((object)null);
        Variant v_OBM_MNARROW = Variant.Create((object)null);
        Variant v_OBM_LFARROWD = Variant.Create((object)null);
        Variant v_OBM_RGARROWD = Variant.Create((object)null);
        Variant v_OBM_DNARROWD = Variant.Create((object)null);
        Variant v_OBM_UPARROWD = Variant.Create((object)null);
        Variant v_OBM_RESTORED = Variant.Create((object)null);
        Variant v_OBM_ZOOMD = Variant.Create((object)null);
        Variant v_OBM_REDUCED = Variant.Create((object)null);
        Variant v_OBM_RESTORE = Variant.Create((object)null);
        Variant v_OBM_ZOOM = Variant.Create((object)null);
        Variant v_OBM_REDUCE = Variant.Create((object)null);
        Variant v_OBM_LFARROW = Variant.Create((object)null);
        Variant v_OBM_RGARROW = Variant.Create((object)null);
        Variant v_OBM_DNARROW = Variant.Create((object)null);
        Variant v_OBM_UPARROW = Variant.Create((object)null);
        Variant v_OBM_CLOSE = Variant.Create((object)null);
        Variant v_OBM_OLD_RESTORE = Variant.Create((object)null);
        Variant v_OBM_OLD_ZOOM = Variant.Create((object)null);
        Variant v_OBM_OLD_REDUCE = Variant.Create((object)null);
        Variant v_OBM_BTNCORNERS = Variant.Create((object)null);
        Variant v_OBM_CHECKBOXES = Variant.Create((object)null);
        Variant v_OBM_CHECK = Variant.Create((object)null);
        Variant v_OBM_BTSIZE = Variant.Create((object)null);
        Variant v_OBM_OLD_LFARROW = Variant.Create((object)null);
        Variant v_OBM_OLD_RGARROW = Variant.Create((object)null);
        Variant v_OBM_OLD_DNARROW = Variant.Create((object)null);
        Variant v_OBM_OLD_UPARROW = Variant.Create((object)null);
        Variant v_OBM_SIZE = Variant.Create((object)null);
        Variant v_OBM_OLD_CLOSE = Variant.Create((object)null);
        Variant v_OIC_SAMPLE = Variant.Create((object)null);
        Variant v_OIC_HAND = Variant.Create((object)null);
        Variant v_OIC_QUES = Variant.Create((object)null);
        Variant v_OIC_BANG = Variant.Create((object)null);
        Variant v_OIC_NOTE = Variant.Create((object)null);
        Variant v_OIC_WINLOGO = Variant.Create((object)null);
        Variant v_OIC_WARNING = Variant.Create((object)null);
        Variant v_OIC_ERROR = Variant.Create((object)null);
        Variant v_OIC_INFORMATION = Variant.Create((object)null);
        Variant v_tagPOINT = Variant.Create((object)null);
        Variant v_tagRECT = Variant.Create((object)null);
        Variant v_tagSIZE = Variant.Create((object)null);
        Variant v_tagMARGINS = Variant.Create((object)null);
        Variant v_tagFILETIME = Variant.Create((object)null);
        Variant v_tagSYSTEMTIME = Variant.Create((object)null);
        Variant v_tagTIME_ZONE_INFORMATION = Variant.Create((object)null);
        Variant v_tagNMHDR = Variant.Create((object)null);
        Variant v_tagCOMBOBOXEXITEM = Variant.Create((object)null);
        Variant v_tagNMCBEDRAGBEGIN = Variant.Create((object)null);
        Variant v_tagNMCBEENDEDIT = Variant.Create((object)null);
        Variant v_tagNMCOMBOBOXEX = Variant.Create((object)null);
        Variant v_tagDTPRANGE = Variant.Create((object)null);
        Variant v_tagNMDATETIMECHANGE = Variant.Create((object)null);
        Variant v_tagNMDATETIMEFORMAT = Variant.Create((object)null);
        Variant v_tagNMDATETIMEFORMATQUERY = Variant.Create((object)null);
        Variant v_tagNMDATETIMEKEYDOWN = Variant.Create((object)null);
        Variant v_tagNMDATETIMESTRING = Variant.Create((object)null);
        Variant v_tagEVENTLOGRECORD = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_Blur = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_BrightnessContrast = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_ColorBalance = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_ColorCurve = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_ColorLUT = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_HueSaturationLightness = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_Levels = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_RedEyeCorrection = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_Sharpen = Variant.Create((object)null);
        Variant v_tagGDIP_EFFECTPARAMS_Tint = Variant.Create((object)null);
        Variant v_tagGDIPBITMAPDATA = Variant.Create((object)null);
        Variant v_tagGDIPCOLORMATRIX = Variant.Create((object)null);
        Variant v_tagGDIPENCODERPARAM = Variant.Create((object)null);
        Variant v_tagGDIPENCODERPARAMS = Variant.Create((object)null);
        Variant v_tagGDIPRECTF = Variant.Create((object)null);
        Variant v_tagGDIPSTARTUPINPUT = Variant.Create((object)null);
        Variant v_tagGDIPSTARTUPOUTPUT = Variant.Create((object)null);
        Variant v_tagGDIPIMAGECODECINFO = Variant.Create((object)null);
        Variant v_tagGDIPPENCODERPARAMS = Variant.Create((object)null);
        Variant v_tagHDITEM = Variant.Create((object)null);
        Variant v_tagNMHDDISPINFO = Variant.Create((object)null);
        Variant v_tagNMHDFILTERBTNCLICK = Variant.Create((object)null);
        Variant v_tagNMHEADER = Variant.Create((object)null);
        Variant v_tagGETIPAddress = Variant.Create((object)null);
        Variant v_tagNMIPADDRESS = Variant.Create((object)null);
        Variant v_tagLVFINDINFO = Variant.Create((object)null);
        Variant v_tagLVHITTESTINFO = Variant.Create((object)null);
        Variant v_tagLVITEM = Variant.Create((object)null);
        Variant v_tagNMLISTVIEW = Variant.Create((object)null);
        Variant v_tagNMLVCUSTOMDRAW = Variant.Create((object)null);
        Variant v_tagNMLVDISPINFO = Variant.Create((object)null);
        Variant v_tagNMLVFINDITEM = Variant.Create((object)null);
        Variant v_tagNMLVGETINFOTIP = Variant.Create((object)null);
        Variant v_tagNMITEMACTIVATE = Variant.Create((object)null);
        Variant v_tagNMLVKEYDOWN = Variant.Create((object)null);
        Variant v_tagNMLVSCROLL = Variant.Create((object)null);
        Variant v_tagMCHITTESTINFO = Variant.Create((object)null);
        Variant v_tagMCMONTHRANGE = Variant.Create((object)null);
        Variant v_tagMCRANGE = Variant.Create((object)null);
        Variant v_tagMCSELRANGE = Variant.Create((object)null);
        Variant v_tagNMDAYSTATE = Variant.Create((object)null);
        Variant v_tagNMSELCHANGE = Variant.Create((object)null);
        Variant v_tagNMOBJECTNOTIFY = Variant.Create((object)null);
        Variant v_tagNMTCKEYDOWN = Variant.Create((object)null);
        Variant v_tagTVITEM = Variant.Create((object)null);
        Variant v_tagTVITEMEX = Variant.Create((object)null);
        Variant v_tagNMTREEVIEW = Variant.Create((object)null);
        Variant v_tagNMTVCUSTOMDRAW = Variant.Create((object)null);
        Variant v_tagNMTVDISPINFO = Variant.Create((object)null);
        Variant v_tagNMTVGETINFOTIP = Variant.Create((object)null);
        Variant v_tagNMTVITEMCHANGE = Variant.Create((object)null);
        Variant v_tagTVHITTESTINFO = Variant.Create((object)null);
        Variant v_tagNMTVKEYDOWN = Variant.Create((object)null);
        Variant v_tagNMMOUSE = Variant.Create((object)null);
        Variant v_tagTOKEN_PRIVILEGES = Variant.Create((object)null);
        Variant v_tagIMAGEINFO = Variant.Create((object)null);
        Variant v_tagMENUINFO = Variant.Create((object)null);
        Variant v_tagMENUITEMINFO = Variant.Create((object)null);
        Variant v_tagREBARBANDINFO = Variant.Create((object)null);
        Variant v_tagNMREBARAUTOBREAK = Variant.Create((object)null);
        Variant v_tagNMRBAUTOSIZE = Variant.Create((object)null);
        Variant v_tagNMREBAR = Variant.Create((object)null);
        Variant v_tagNMREBARCHEVRON = Variant.Create((object)null);
        Variant v_tagNMREBARCHILDSIZE = Variant.Create((object)null);
        Variant v_tagCOLORSCHEME = Variant.Create((object)null);
        Variant v_tagNMTOOLBAR = Variant.Create((object)null);
        Variant v_tagNMTBHOTITEM = Variant.Create((object)null);
        Variant v_tagTBBUTTON = Variant.Create((object)null);
        Variant v_tagTBBUTTONINFO = Variant.Create((object)null);
        Variant v_tagNETRESOURCE = Variant.Create((object)null);
        Variant v_tagOVERLAPPED = Variant.Create((object)null);
        Variant v_tagOPENFILENAME = Variant.Create((object)null);
        Variant v_tagBITMAPINFOHEADER = Variant.Create((object)null);
        Variant v_tagBITMAPINFO = Variant.Create((object)null);
        Variant v_tagBLENDFUNCTION = Variant.Create((object)null);
        Variant v_tagGUID = Variant.Create((object)null);
        Variant v_tagWINDOWPLACEMENT = Variant.Create((object)null);
        Variant v_tagWINDOWPOS = Variant.Create((object)null);
        Variant v_tagSCROLLINFO = Variant.Create((object)null);
        Variant v_tagSCROLLBARINFO = Variant.Create((object)null);
        Variant v_tagLOGFONT = Variant.Create((object)null);
        Variant v_tagKBDLLHOOKSTRUCT = Variant.Create((object)null);
        Variant v_tagPROCESS_INFORMATION = Variant.Create((object)null);
        Variant v_tagSTARTUPINFO = Variant.Create((object)null);
        Variant v_tagSECURITY_ATTRIBUTES = Variant.Create((object)null);
        Variant v_tagWIN32_FIND_DATA = Variant.Create((object)null);
        Variant v_tagTEXTMETRIC = Variant.Create((object)null);
        Variant v_STR_NOCASESENSE = Variant.Create((object)null);
        Variant v_STR_CASESENSE = Variant.Create((object)null);
        Variant v_STR_NOCASESENSEBASIC = Variant.Create((object)null);
        Variant v_STR_STRIPLEADING = Variant.Create((object)null);
        Variant v_STR_STRIPTRAILING = Variant.Create((object)null);
        Variant v_STR_STRIPSPACES = Variant.Create((object)null);
        Variant v_STR_STRIPALL = Variant.Create((object)null);
        Variant v_STR_CHRSPLIT = Variant.Create((object)null);
        Variant v_STR_ENTIRESPLIT = Variant.Create((object)null);
        Variant v_STR_NOCOUNT = Variant.Create((object)null);
        Variant v_STR_REGEXPMATCH = Variant.Create((object)null);
        Variant v_STR_REGEXPARRAYMATCH = Variant.Create((object)null);
        Variant v_STR_REGEXPARRAYFULLMATCH = Variant.Create((object)null);
        Variant v_STR_REGEXPARRAYGLOBALMATCH = Variant.Create((object)null);
        Variant v_STR_REGEXPARRAYGLOBALFULLMATCH = Variant.Create((object)null);
        Variant v_STR_ENDISSTART = Variant.Create((object)null);
        Variant v_STR_ENDNOTSTART = Variant.Create((object)null);
        Variant v_SE_ASSIGNPRIMARYTOKEN_NAME = Variant.Create((object)null);
        Variant v_SE_AUDIT_NAME = Variant.Create((object)null);
        Variant v_SE_BACKUP_NAME = Variant.Create((object)null);
        Variant v_SE_CHANGE_NOTIFY_NAME = Variant.Create((object)null);
        Variant v_SE_CREATE_GLOBAL_NAME = Variant.Create((object)null);
        Variant v_SE_CREATE_PAGEFILE_NAME = Variant.Create((object)null);
        Variant v_SE_CREATE_PERMANENT_NAME = Variant.Create((object)null);
        Variant v_SE_CREATE_SYMBOLIC_LINK_NAME = Variant.Create((object)null);
        Variant v_SE_CREATE_TOKEN_NAME = Variant.Create((object)null);
        Variant v_SE_DEBUG_NAME = Variant.Create((object)null);
        Variant v_SE_ENABLE_DELEGATION_NAME = Variant.Create((object)null);
        Variant v_SE_IMPERSONATE_NAME = Variant.Create((object)null);
        Variant v_SE_INC_BASE_PRIORITY_NAME = Variant.Create((object)null);
        Variant v_SE_INC_WORKING_SET_NAME = Variant.Create((object)null);
        Variant v_SE_INCREASE_QUOTA_NAME = Variant.Create((object)null);
        Variant v_SE_LOAD_DRIVER_NAME = Variant.Create((object)null);
        Variant v_SE_LOCK_MEMORY_NAME = Variant.Create((object)null);
        Variant v_SE_MACHINE_ACCOUNT_NAME = Variant.Create((object)null);
        Variant v_SE_MANAGE_VOLUME_NAME = Variant.Create((object)null);
        Variant v_SE_PROF_SINGLE_PROCESS_NAME = Variant.Create((object)null);
        Variant v_SE_RELABEL_NAME = Variant.Create((object)null);
        Variant v_SE_REMOTE_SHUTDOWN_NAME = Variant.Create((object)null);
        Variant v_SE_RESTORE_NAME = Variant.Create((object)null);
        Variant v_SE_SECURITY_NAME = Variant.Create((object)null);
        Variant v_SE_SHUTDOWN_NAME = Variant.Create((object)null);
        Variant v_SE_SYNC_AGENT_NAME = Variant.Create((object)null);
        Variant v_SE_SYSTEM_ENVIRONMENT_NAME = Variant.Create((object)null);
        Variant v_SE_SYSTEM_PROFILE_NAME = Variant.Create((object)null);
        Variant v_SE_SYSTEMTIME_NAME = Variant.Create((object)null);
        Variant v_SE_TAKE_OWNERSHIP_NAME = Variant.Create((object)null);
        Variant v_SE_TCB_NAME = Variant.Create((object)null);
        Variant v_SE_TIME_ZONE_NAME = Variant.Create((object)null);
        Variant v_SE_TRUSTED_CREDMAN_ACCESS_NAME = Variant.Create((object)null);
        Variant v_SE_UNSOLICITED_INPUT_NAME = Variant.Create((object)null);
        Variant v_SE_UNDOCK_NAME = Variant.Create((object)null);
        Variant v_SE_PRIVILEGE_ENABLED_BY_DEFAULT = Variant.Create((object)null);
        Variant v_SE_PRIVILEGE_ENABLED = Variant.Create((object)null);
        Variant v_SE_PRIVILEGE_REMOVED = Variant.Create((object)null);
        Variant v_SE_PRIVILEGE_USED_FOR_ACCESS = Variant.Create((object)null);
        Variant v_SE_GROUP_MANDATORY = Variant.Create((object)null);
        Variant v_SE_GROUP_ENABLED_BY_DEFAULT = Variant.Create((object)null);
        Variant v_SE_GROUP_ENABLED = Variant.Create((object)null);
        Variant v_SE_GROUP_OWNER = Variant.Create((object)null);
        Variant v_SE_GROUP_USE_FOR_DENY_ONLY = Variant.Create((object)null);
        Variant v_SE_GROUP_INTEGRITY = Variant.Create((object)null);
        Variant v_SE_GROUP_INTEGRITY_ENABLED = Variant.Create((object)null);
        Variant v_SE_GROUP_RESOURCE = Variant.Create((object)null);
        Variant v_SE_GROUP_LOGON_ID = Variant.Create((object)null);
        Variant v_TOKENPRIMARY = Variant.Create((object)null);
        Variant v_TOKENIMPERSONATION = Variant.Create((object)null);
        Variant v_SECURITYANONYMOUS = Variant.Create((object)null);
        Variant v_SECURITYIDENTIFICATION = Variant.Create((object)null);
        Variant v_SECURITYIMPERSONATION = Variant.Create((object)null);
        Variant v_SECURITYDELEGATION = Variant.Create((object)null);
        Variant v_TOKENUSER = Variant.Create((object)null);
        Variant v_TOKENGROUPS = Variant.Create((object)null);
        Variant v_TOKENPRIVILEGES = Variant.Create((object)null);
        Variant v_TOKENOWNER = Variant.Create((object)null);
        Variant v_TOKENPRIMARYGROUP = Variant.Create((object)null);
        Variant v_TOKENDEFAULTDACL = Variant.Create((object)null);
        Variant v_TOKENSOURCE = Variant.Create((object)null);
        Variant v_TOKENTYPE = Variant.Create((object)null);
        Variant v_TOKENIMPERSONATIONLEVEL = Variant.Create((object)null);
        Variant v_TOKENSTATISTICS = Variant.Create((object)null);
        Variant v_TOKENRESTRICTEDSIDS = Variant.Create((object)null);
        Variant v_TOKENSESSIONID = Variant.Create((object)null);
        Variant v_TOKENGROUPSANDPRIVILEGES = Variant.Create((object)null);
        Variant v_TOKENSESSIONREFERENCE = Variant.Create((object)null);
        Variant v_TOKENSANDBOXINERT = Variant.Create((object)null);
        Variant v_TOKENAUDITPOLICY = Variant.Create((object)null);
        Variant v_TOKENORIGIN = Variant.Create((object)null);
        Variant v_TOKENELEVATIONTYPE = Variant.Create((object)null);
        Variant v_TOKENLINKEDTOKEN = Variant.Create((object)null);
        Variant v_TOKENELEVATION = Variant.Create((object)null);
        Variant v_TOKENHASRESTRICTIONS = Variant.Create((object)null);
        Variant v_TOKENACCESSINFORMATION = Variant.Create((object)null);
        Variant v_TOKENVIRTUALIZATIONALLOWED = Variant.Create((object)null);
        Variant v_TOKENVIRTUALIZATIONENABLED = Variant.Create((object)null);
        Variant v_TOKENINTEGRITYLEVEL = Variant.Create((object)null);
        Variant v_TOKENUIACCESS = Variant.Create((object)null);
        Variant v_TOKENMANDATORYPOLICY = Variant.Create((object)null);
        Variant v_TOKENLOGONSID = Variant.Create((object)null);
        Variant v_TOKEN_ASSIGN_PRIMARY = Variant.Create((object)null);
        Variant v_TOKEN_DUPLICATE = Variant.Create((object)null);
        Variant v_TOKEN_IMPERSONATE = Variant.Create((object)null);
        Variant v_TOKEN_QUERY = Variant.Create((object)null);
        Variant v_TOKEN_QUERY_SOURCE = Variant.Create((object)null);
        Variant v_TOKEN_ADJUST_PRIVILEGES = Variant.Create((object)null);
        Variant v_TOKEN_ADJUST_GROUPS = Variant.Create((object)null);
        Variant v_TOKEN_ADJUST_DEFAULT = Variant.Create((object)null);
        Variant v_TOKEN_ADJUST_SESSIONID = Variant.Create((object)null);
        Variant v_TOKEN_ALL_ACCESS = Variant.Create((object)null);
        Variant v_TOKEN_READ = Variant.Create((object)null);
        Variant v_TOKEN_WRITE = Variant.Create((object)null);
        Variant v_TOKEN_EXECUTE = Variant.Create((object)null);
        Variant v_TOKEN_HAS_TRAVERSE_PRIVILEGE = Variant.Create((object)null);
        Variant v_TOKEN_HAS_BACKUP_PRIVILEGE = Variant.Create((object)null);
        Variant v_TOKEN_HAS_RESTORE_PRIVILEGE = Variant.Create((object)null);
        Variant v_TOKEN_HAS_ADMIN_GROUP = Variant.Create((object)null);
        Variant v_TOKEN_IS_RESTRICTED = Variant.Create((object)null);
        Variant v_TOKEN_SESSION_NOT_REFERENCED = Variant.Create((object)null);
        Variant v_TOKEN_SANDBOX_INERT = Variant.Create((object)null);
        Variant v_TOKEN_HAS_IMPERSONATE_PRIVILEGE = Variant.Create((object)null);
        Variant v_RIGHTS_DELETE = Variant.Create((object)null);
        Variant v_READ_CONTROL = Variant.Create((object)null);
        Variant v_WRITE_DAC = Variant.Create((object)null);
        Variant v_WRITE_OWNER = Variant.Create((object)null);
        Variant v_SYNCHRONIZE = Variant.Create((object)null);
        Variant v_ACCESS_SYSTEM_SECURITY = Variant.Create((object)null);
        Variant v_STANDARD_RIGHTS_REQUIRED = Variant.Create((object)null);
        Variant v_STANDARD_RIGHTS_READ = Variant.Create((object)null);
        Variant v_STANDARD_RIGHTS_WRITE = Variant.Create((object)null);
        Variant v_STANDARD_RIGHTS_EXECUTE = Variant.Create((object)null);
        Variant v_STANDARD_RIGHTS_ALL = Variant.Create((object)null);
        Variant v_SPECIFIC_RIGHTS_ALL = Variant.Create((object)null);
        Variant v_NOT_USED_ACCESS = Variant.Create((object)null);
        Variant v_GRANT_ACCESS = Variant.Create((object)null);
        Variant v_SET_ACCESS = Variant.Create((object)null);
        Variant v_DENY_ACCESS = Variant.Create((object)null);
        Variant v_REVOKE_ACCESS = Variant.Create((object)null);
        Variant v_SET_AUDIT_SUCCESS = Variant.Create((object)null);
        Variant v_SET_AUDIT_FAILURE = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_UNKNOWN = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_USER = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_GROUP = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_DOMAIN = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_ALIAS = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_WELL_KNOWN_GROUP = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_DELETED = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_INVALID = Variant.Create((object)null);
        Variant v_TRUSTEE_IS_COMPUTER = Variant.Create((object)null);
        Variant v_LOGON_WITH_PROFILE = Variant.Create((object)null);
        Variant v_LOGON_NETCREDENTIALS_ONLY = Variant.Create((object)null);
        Variant v_SIDTYPEUSER = Variant.Create((object)null);
        Variant v_SIDTYPEGROUP = Variant.Create((object)null);
        Variant v_SIDTYPEDOMAIN = Variant.Create((object)null);
        Variant v_SIDTYPEALIAS = Variant.Create((object)null);
        Variant v_SIDTYPEWELLKNOWNGROUP = Variant.Create((object)null);
        Variant v_SIDTYPEDELETEDACCOUNT = Variant.Create((object)null);
        Variant v_SIDTYPEINVALID = Variant.Create((object)null);
        Variant v_SIDTYPEUNKNOWN = Variant.Create((object)null);
        Variant v_SIDTYPECOMPUTER = Variant.Create((object)null);
        Variant v_SIDTYPELABEL = Variant.Create((object)null);
        Variant v_SID_ADMINISTRATORS = Variant.Create((object)null);
        Variant v_SID_USERS = Variant.Create((object)null);
        Variant v_SID_GUESTS = Variant.Create((object)null);
        Variant v_SID_ACCOUNT_OPERATORS = Variant.Create((object)null);
        Variant v_SID_SERVER_OPERATORS = Variant.Create((object)null);
        Variant v_SID_PRINT_OPERATORS = Variant.Create((object)null);
        Variant v_SID_BACKUP_OPERATORS = Variant.Create((object)null);
        Variant v_SID_REPLICATOR = Variant.Create((object)null);
        Variant v_SID_OWNER = Variant.Create((object)null);
        Variant v_SID_EVERYONE = Variant.Create((object)null);
        Variant v_SID_NETWORK = Variant.Create((object)null);
        Variant v_SID_INTERACTIVE = Variant.Create((object)null);
        Variant v_SID_SYSTEM = Variant.Create((object)null);
        Variant v_SID_AUTHENTICATED_USERS = Variant.Create((object)null);
        Variant v_SID_SCHANNEL_AUTHENTICATION = Variant.Create((object)null);
        Variant v_SID_DIGEST_AUTHENTICATION = Variant.Create((object)null);
        Variant v_SID_NT_SERVICE = Variant.Create((object)null);
        Variant v_SID_UNTRUSTED_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_LOW_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_MEDIUM_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_MEDIUM_PLUS_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_HIGH_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_SYSTEM_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_PROTECTED_PROCESS_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_SECURE_PROCESS_MANDATORY_LEVEL = Variant.Create((object)null);
        Variant v_SID_ALL_SERVICES = Variant.Create((object)null);
        Variant v_MB_OK = Variant.Create((object)null);
        Variant v_MB_OKCANCEL = Variant.Create((object)null);
        Variant v_MB_ABORTRETRYIGNORE = Variant.Create((object)null);
        Variant v_MB_YESNOCANCEL = Variant.Create((object)null);
        Variant v_MB_YESNO = Variant.Create((object)null);
        Variant v_MB_RETRYCANCEL = Variant.Create((object)null);
        Variant v_MB_CANCELTRYCONTINUE = Variant.Create((object)null);
        Variant v_MB_HELP = Variant.Create((object)null);
        Variant v_MB_ICONSTOP = Variant.Create((object)null);
        Variant v_MB_ICONERROR = Variant.Create((object)null);
        Variant v_MB_ICONHAND = Variant.Create((object)null);
        Variant v_MB_ICONQUESTION = Variant.Create((object)null);
        Variant v_MB_ICONEXCLAMATION = Variant.Create((object)null);
        Variant v_MB_ICONWARNING = Variant.Create((object)null);
        Variant v_MB_ICONINFORMATION = Variant.Create((object)null);
        Variant v_MB_ICONASTERISK = Variant.Create((object)null);
        Variant v_MB_USERICON = Variant.Create((object)null);
        Variant v_MB_DEFBUTTON1 = Variant.Create((object)null);
        Variant v_MB_DEFBUTTON2 = Variant.Create((object)null);
        Variant v_MB_DEFBUTTON3 = Variant.Create((object)null);
        Variant v_MB_DEFBUTTON4 = Variant.Create((object)null);
        Variant v_MB_APPLMODAL = Variant.Create((object)null);
        Variant v_MB_SYSTEMMODAL = Variant.Create((object)null);
        Variant v_MB_TASKMODAL = Variant.Create((object)null);
        Variant v_MB_DEFAULT_DESKTOP_ONLY = Variant.Create((object)null);
        Variant v_MB_RIGHT = Variant.Create((object)null);
        Variant v_MB_RTLREADING = Variant.Create((object)null);
        Variant v_MB_SETFOREGROUND = Variant.Create((object)null);
        Variant v_MB_TOPMOST = Variant.Create((object)null);
        Variant v_MB_SERVICE_NOTIFICATION = Variant.Create((object)null);
        Variant v_MB_RIGHTJUSTIFIED = Variant.Create((object)null);
        Variant v_IDTIMEOUT = Variant.Create((object)null);
        Variant v_IDOK = Variant.Create((object)null);
        Variant v_IDCANCEL = Variant.Create((object)null);
        Variant v_IDABORT = Variant.Create((object)null);
        Variant v_IDRETRY = Variant.Create((object)null);
        Variant v_IDIGNORE = Variant.Create((object)null);
        Variant v_IDYES = Variant.Create((object)null);
        Variant v_IDNO = Variant.Create((object)null);
        Variant v_IDCLOSE = Variant.Create((object)null);
        Variant v_IDHELP = Variant.Create((object)null);
        Variant v_IDTRYAGAIN = Variant.Create((object)null);
        Variant v_IDCONTINUE = Variant.Create((object)null);
        Variant v_FC_NOOVERWRITE = Variant.Create((object)null);
        Variant v_FC_OVERWRITE = Variant.Create((object)null);
        Variant v_FC_CREATEPATH = Variant.Create((object)null);
        Variant v_FT_MODIFIED = Variant.Create((object)null);
        Variant v_FT_CREATED = Variant.Create((object)null);
        Variant v_FT_ACCESSED = Variant.Create((object)null);
        Variant v_FO_READ = Variant.Create((object)null);
        Variant v_FO_APPEND = Variant.Create((object)null);
        Variant v_FO_OVERWRITE = Variant.Create((object)null);
        Variant v_FO_CREATEPATH = Variant.Create((object)null);
        Variant v_FO_BINARY = Variant.Create((object)null);
        Variant v_FO_UNICODE = Variant.Create((object)null);
        Variant v_FO_UTF16_LE = Variant.Create((object)null);
        Variant v_FO_UTF16_BE = Variant.Create((object)null);
        Variant v_FO_UTF8 = Variant.Create((object)null);
        Variant v_FO_UTF8_NOBOM = Variant.Create((object)null);
        Variant v_FO_UTF8_FULL = Variant.Create((object)null);
        Variant v_EOF = Variant.Create((object)null);
        Variant v_FD_FILEMUSTEXIST = Variant.Create((object)null);
        Variant v_FD_PATHMUSTEXIST = Variant.Create((object)null);
        Variant v_FD_MULTISELECT = Variant.Create((object)null);
        Variant v_FD_PROMPTCREATENEW = Variant.Create((object)null);
        Variant v_FD_PROMPTOVERWRITE = Variant.Create((object)null);
        Variant v_CREATE_NEW = Variant.Create((object)null);
        Variant v_CREATE_ALWAYS = Variant.Create((object)null);
        Variant v_OPEN_EXISTING = Variant.Create((object)null);
        Variant v_OPEN_ALWAYS = Variant.Create((object)null);
        Variant v_TRUNCATE_EXISTING = Variant.Create((object)null);
        Variant v_INVALID_SET_FILE_POINTER = Variant.Create((object)null);
        Variant v_FILE_BEGIN = Variant.Create((object)null);
        Variant v_FILE_CURRENT = Variant.Create((object)null);
        Variant v_FILE_END = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_READONLY = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_HIDDEN = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_SYSTEM = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_DIRECTORY = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_ARCHIVE = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_DEVICE = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_NORMAL = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_TEMPORARY = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_SPARSE_FILE = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_REPARSE_POINT = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_COMPRESSED = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_OFFLINE = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_NOT_CONTENT_INDEXED = Variant.Create((object)null);
        Variant v_FILE_ATTRIBUTE_ENCRYPTED = Variant.Create((object)null);
        Variant v_FILE_SHARE_READ = Variant.Create((object)null);
        Variant v_FILE_SHARE_WRITE = Variant.Create((object)null);
        Variant v_FILE_SHARE_DELETE = Variant.Create((object)null);
        Variant v_FILE_SHARE_READWRITE = Variant.Create((object)null);
        Variant v_FILE_SHARE_ANY = Variant.Create((object)null);
        Variant v_GENERIC_ALL = Variant.Create((object)null);
        Variant v_GENERIC_EXECUTE = Variant.Create((object)null);
        Variant v_GENERIC_WRITE = Variant.Create((object)null);
        Variant v_GENERIC_READ = Variant.Create((object)null);
        Variant v_GENERIC_READWRITE = Variant.Create((object)null);
        Variant v_FRTA_NOCOUNT = Variant.Create((object)null);
        Variant v_FRTA_COUNT = Variant.Create((object)null);
        Variant v_FRTA_INTARRAYS = Variant.Create((object)null);
        Variant v_FRTA_ENTIRESPLIT = Variant.Create((object)null);
        Variant v_FLTA_FILESFOLDERS = Variant.Create((object)null);
        Variant v_FLTA_FILES = Variant.Create((object)null);
        Variant v_FLTA_FOLDERS = Variant.Create((object)null);
        Variant v_FLTAR_FILESFOLDERS = Variant.Create((object)null);
        Variant v_FLTAR_FILES = Variant.Create((object)null);
        Variant v_FLTAR_FOLDERS = Variant.Create((object)null);
        Variant v_FLTAR_NOHIDDEN = Variant.Create((object)null);
        Variant v_FLTAR_NOSYSTEM = Variant.Create((object)null);
        Variant v_FLTAR_NOLINK = Variant.Create((object)null);
        Variant v_FLTAR_NORECUR = Variant.Create((object)null);
        Variant v_FLTAR_RECUR = Variant.Create((object)null);
        Variant v_FLTAR_NOSORT = Variant.Create((object)null);
        Variant v_FLTAR_SORT = Variant.Create((object)null);
        Variant v_FLTAR_FASTSORT = Variant.Create((object)null);
        Variant v_FLTAR_NOPATH = Variant.Create((object)null);
        Variant v_FLTAR_RELPATH = Variant.Create((object)null);
        Variant v_FLTAR_FULLPATH = Variant.Create((object)null);
        Variant v_OPT_COORDSRELATIVE = Variant.Create((object)null);
        Variant v_OPT_COORDSABSOLUTE = Variant.Create((object)null);
        Variant v_OPT_COORDSCLIENT = Variant.Create((object)null);
        Variant v_OPT_ERRORSILENT = Variant.Create((object)null);
        Variant v_OPT_ERRORFATAL = Variant.Create((object)null);
        Variant v_OPT_CAPSNOSTORE = Variant.Create((object)null);
        Variant v_OPT_CAPSSTORE = Variant.Create((object)null);
        Variant v_OPT_MATCHSTART = Variant.Create((object)null);
        Variant v_OPT_MATCHANY = Variant.Create((object)null);
        Variant v_OPT_MATCHEXACT = Variant.Create((object)null);
        Variant v_OPT_MATCHADVANCED = Variant.Create((object)null);
        Variant v_CCS_TOP = Variant.Create((object)null);
        Variant v_CCS_NOMOVEY = Variant.Create((object)null);
        Variant v_CCS_BOTTOM = Variant.Create((object)null);
        Variant v_CCS_NORESIZE = Variant.Create((object)null);
        Variant v_CCS_NOPARENTALIGN = Variant.Create((object)null);
        Variant v_CCS_NOHILITE = Variant.Create((object)null);
        Variant v_CCS_ADJUSTABLE = Variant.Create((object)null);
        Variant v_CCS_NODIVIDER = Variant.Create((object)null);
        Variant v_CCS_VERT = Variant.Create((object)null);
        Variant v_CCS_LEFT = Variant.Create((object)null);
        Variant v_CCS_NOMOVEX = Variant.Create((object)null);
        Variant v_CCS_RIGHT = Variant.Create((object)null);
        Variant v_DT_DRIVETYPE = Variant.Create((object)null);
        Variant v_DT_SSDSTATUS = Variant.Create((object)null);
        Variant v_DT_BUSTYPE = Variant.Create((object)null);
        Variant v_OBJID_WINDOW = Variant.Create((object)null);
        Variant v_OBJID_TITLEBAR = Variant.Create((object)null);
        Variant v_OBJID_SIZEGRIP = Variant.Create((object)null);
        Variant v_OBJID_CARET = Variant.Create((object)null);
        Variant v_OBJID_CURSOR = Variant.Create((object)null);
        Variant v_OBJID_ALERT = Variant.Create((object)null);
        Variant v_OBJID_SOUND = Variant.Create((object)null);
        Variant v_DLG_NOTITLE = Variant.Create((object)null);
        Variant v_DLG_NOTONTOP = Variant.Create((object)null);
        Variant v_DLG_TEXTLEFT = Variant.Create((object)null);
        Variant v_DLG_TEXTRIGHT = Variant.Create((object)null);
        Variant v_DLG_MOVEABLE = Variant.Create((object)null);
        Variant v_DLG_TEXTVCENTER = Variant.Create((object)null);
        Variant v_IDC_UNKNOWN = Variant.Create((object)null);
        Variant v_IDC_APPSTARTING = Variant.Create((object)null);
        Variant v_IDC_ARROW = Variant.Create((object)null);
        Variant v_IDC_CROSS = Variant.Create((object)null);
        Variant v_IDC_HAND = Variant.Create((object)null);
        Variant v_IDC_HELP = Variant.Create((object)null);
        Variant v_IDC_IBEAM = Variant.Create((object)null);
        Variant v_IDC_ICON = Variant.Create((object)null);
        Variant v_IDC_NO = Variant.Create((object)null);
        Variant v_IDC_SIZE = Variant.Create((object)null);
        Variant v_IDC_SIZEALL = Variant.Create((object)null);
        Variant v_IDC_SIZENESW = Variant.Create((object)null);
        Variant v_IDC_SIZENS = Variant.Create((object)null);
        Variant v_IDC_SIZENWSE = Variant.Create((object)null);
        Variant v_IDC_SIZEWE = Variant.Create((object)null);
        Variant v_IDC_UPARROW = Variant.Create((object)null);
        Variant v_IDC_WAIT = Variant.Create((object)null);
        Variant v_IDI_APPLICATION = Variant.Create((object)null);
        Variant v_IDI_ASTERISK = Variant.Create((object)null);
        Variant v_IDI_EXCLAMATION = Variant.Create((object)null);
        Variant v_IDI_HAND = Variant.Create((object)null);
        Variant v_IDI_QUESTION = Variant.Create((object)null);
        Variant v_IDI_WINLOGO = Variant.Create((object)null);
        Variant v_IDI_SHIELD = Variant.Create((object)null);
        Variant v_IDI_ERROR = Variant.Create((object)null);
        Variant v_IDI_INFORMATION = Variant.Create((object)null);
        Variant v_IDI_WARNING = Variant.Create((object)null);
        Variant v_SD_LOGOFF = Variant.Create((object)null);
        Variant v_SD_SHUTDOWN = Variant.Create((object)null);
        Variant v_SD_REBOOT = Variant.Create((object)null);
        Variant v_SD_FORCE = Variant.Create((object)null);
        Variant v_SD_POWERDOWN = Variant.Create((object)null);
        Variant v_SD_FORCEHUNG = Variant.Create((object)null);
        Variant v_SD_STANDBY = Variant.Create((object)null);
        Variant v_SD_HIBERNATE = Variant.Create((object)null);
        Variant v_STDIN_CHILD = Variant.Create((object)null);
        Variant v_STDOUT_CHILD = Variant.Create((object)null);
        Variant v_STDERR_CHILD = Variant.Create((object)null);
        Variant v_STDERR_MERGED = Variant.Create((object)null);
        Variant v_STDIO_INHERIT_PARENT = Variant.Create((object)null);
        Variant v_RUN_CREATE_NEW_CONSOLE = Variant.Create((object)null);
        Variant v_UBOUND_DIMENSIONS = Variant.Create((object)null);
        Variant v_UBOUND_ROWS = Variant.Create((object)null);
        Variant v_UBOUND_COLUMNS = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_ABSOLUTE = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_MOVE = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_LEFTDOWN = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_LEFTUP = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_RIGHTDOWN = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_RIGHTUP = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_MIDDLEDOWN = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_MIDDLEUP = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_WHEEL = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_XDOWN = Variant.Create((object)null);
        Variant v_MOUSEEVENTF_XUP = Variant.Create((object)null);
        Variant v_REG_NONE = Variant.Create((object)null);
        Variant v_REG_SZ = Variant.Create((object)null);
        Variant v_REG_EXPAND_SZ = Variant.Create((object)null);
        Variant v_REG_BINARY = Variant.Create((object)null);
        Variant v_REG_DWORD = Variant.Create((object)null);
        Variant v_REG_DWORD_LITTLE_ENDIAN = Variant.Create((object)null);
        Variant v_REG_DWORD_BIG_ENDIAN = Variant.Create((object)null);
        Variant v_REG_LINK = Variant.Create((object)null);
        Variant v_REG_MULTI_SZ = Variant.Create((object)null);
        Variant v_REG_RESOURCE_LIST = Variant.Create((object)null);
        Variant v_REG_FULL_RESOURCE_DESCRIPTOR = Variant.Create((object)null);
        Variant v_REG_RESOURCE_REQUIREMENTS_LIST = Variant.Create((object)null);
        Variant v_REG_QWORD = Variant.Create((object)null);
        Variant v_REG_QWORD_LITTLE_ENDIAN = Variant.Create((object)null);
        Variant v_HWND_BOTTOM = Variant.Create((object)null);
        Variant v_HWND_NOTOPMOST = Variant.Create((object)null);
        Variant v_HWND_TOP = Variant.Create((object)null);
        Variant v_HWND_TOPMOST = Variant.Create((object)null);
        Variant v_SWP_NOSIZE = Variant.Create((object)null);
        Variant v_SWP_NOMOVE = Variant.Create((object)null);
        Variant v_SWP_NOZORDER = Variant.Create((object)null);
        Variant v_SWP_NOREDRAW = Variant.Create((object)null);
        Variant v_SWP_NOACTIVATE = Variant.Create((object)null);
        Variant v_SWP_FRAMECHANGED = Variant.Create((object)null);
        Variant v_SWP_DRAWFRAME = Variant.Create((object)null);
        Variant v_SWP_SHOWWINDOW = Variant.Create((object)null);
        Variant v_SWP_HIDEWINDOW = Variant.Create((object)null);
        Variant v_SWP_NOCOPYBITS = Variant.Create((object)null);
        Variant v_SWP_NOOWNERZORDER = Variant.Create((object)null);
        Variant v_SWP_NOREPOSITION = Variant.Create((object)null);
        Variant v_SWP_NOSENDCHANGING = Variant.Create((object)null);
        Variant v_SWP_DEFERERASE = Variant.Create((object)null);
        Variant v_SWP_ASYNCWINDOWPOS = Variant.Create((object)null);
        Variant v_KEYWORD_DEFAULT = Variant.Create((object)null);
        Variant v_KEYWORD_NULL = Variant.Create((object)null);
        Variant v___g_aInProcess_WinAPI = Variant.Create((object)null);
        Variant v___g_aWinList_WinAPI = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_WM_SETFONT = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_FW_NORMAL = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_DEFAULT_CHARSET = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_OUT_DEFAULT_PRECIS = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_CLIP_DEFAULT_PRECIS = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_DEFAULT_QUALITY = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_LOGPIXELSX = Variant.Create((object)null);
        Variant v___WINAPICONSTANT_LOGPIXELSY = Variant.Create((object)null);
        Variant v_tagCURSORINFO = Variant.Create((object)null);
        Variant v_tagDISPLAY_DEVICE = Variant.Create((object)null);
        Variant v_tagFLASHWINFO = Variant.Create((object)null);
        Variant v_tagICONINFO = Variant.Create((object)null);
        Variant v_tagMEMORYSTATUSEX = Variant.Create((object)null);
        ...
        public Variant f__Security__SetPrivilege(Variant v_hToken, Variant v_sPrivilege, Variant v_bEnable)
        {
            ...
            if (_functions.NOT(f__Security__AdjustTokenPrivileges(v_hToken, Variant.Create(false), v_tCurrState, v_iCurrState, v_tPrevState, v_tRequired)))
            {
            ...
            if (_functions.NOT(f__Security__AdjustTokenPrivileges(v_hToken, Variant.Create(false), v_tPrevState, v_iPrevState, v_tCurrState, v_tRequired)))
            {
        ...
        public Variant f__Security__SidTypeStr(Variant v_iType)
        {
            ...
            else if (_functions.Equal(v_iType, v_SIDTYPEGROUP))
            {
                return Variant.Create("Group");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPEDOMAIN))
            {
                return Variant.Create("Domain");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPEALIAS))
            {
                return Variant.Create("Alias");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPEWELLKNOWNGROUP))
            {
                return Variant.Create("Well Known Group");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPEDELETEDACCOUNT))
            {
                return Variant.Create("Deleted Account");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPEINVALID))
            {
                return Variant.Create("Invalid");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPEUNKNOWN))
            {
                return Variant.Create("Unknown Type");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPECOMPUTER))
            {
                return Variant.Create("Computer");
            }
            else if (_functions.Equal(v_iType, v_SIDTYPELABEL))
            {
        ...
        public Variant f__WinAPI_CommDlgExtendedError()
        {
            ...
            if (_functions.NOT(_context.Error))
            {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_FINDRESFAILURE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_INITIALIZATION))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_LOADRESFAILURE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_LOADSTRFAILURE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_LOCKRESFAILURE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_MEMALLOCFAILURE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_MEMLOCKFAILURE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_NOHINSTANCE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_NOHOOK))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_NOTEMPLATE))
                {
                    return _functions.SetError(v_aResult[Variant.Create(0)], Variant.Create(0), _functions.Concat(_functions.Concat(Variant.Create("The ENABLETEMPLATE flag was set in the Flags member of the initialization structure for the corresponding common dialog box,"), _context.LF), Variant.Create("but you failed to provide a corresponding template.")));
                }
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_REGISTERMSGFAIL))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_CDERR_STRUCTSIZE))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_FNERR_BUFFERTOOSMALL))
                {
                ...
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_FNERR_INVALIDFILENAME))
                {
                    return _functions.SetError(v_aResult[Variant.Create(0)], Variant.Create(0), Variant.Create("A file name is invalid."));
                }
                else if (_functions.Equal(v_aResult[Variant.Create(0)], v_FNERR_SUBCLASSFAILURE))
                {
        ...
        public Variant f__WinAPI_GetOpenFileName(Variant v_sTitle = null, Variant v_sFilter = null, Variant v_sInitalDir = null, Variant v_sDefaultFile = null, Variant v_sDefaultExt = null, Variant v_iFilterIndex = null, Variant v_iFlags = null, Variant v_iFlagsEx = null, Variant v_hWndOwner = null)
        {
            ...
            v_aFiles.InitArray(new Variant[]
            {
            Variant.Create(0)}
        ...
        ExitLooP_level_1_count_1:
            ...
            else if (_functions.BitAND(v_iFlags, v_OFN_ALLOWMULTISELECT) == v_OFN_ALLOWMULTISELECT)
            {
                v_aFiles = _functions.StringSplit(_functions.DllStructGetData(v_tPath, Variant.Create("Path")), Variant.Create(" "));
                if (v_aFiles[Variant.Create(0)] == Variant.Create(1))
                {
        ...
        public Variant f__WinAPI_GetStdHandle(Variant v_iStdHandle)
        {
            ...
            v_aHandle.InitArray(new Variant[]
            {
