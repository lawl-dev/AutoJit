...
namespace AutoJIT.Parser.Lex
{
    public sealed class Token
    {
        ...
        public bool IsLiteral {
            get { return Type == TokenType.String || Type == TokenType.Int32 || Type == TokenType.Int64 || Type == TokenType.Double || Type == TokenType.Macro; }
        }

        public bool IsBinaryExpression {
            get { return IsMathExpression || IsNumberExpression || IsBooleanExpression || Type == TokenType.StringEqual || Type == TokenType.Concat; }
        }

        public bool IsMathExpression {
            get { return Type == TokenType.Div || Type == TokenType.Mult || Type == TokenType.Minus || Type == TokenType.Plus || Type == TokenType.Pow; }
        }

        public bool IsNumberExpression {
            get { return Type == TokenType.Greater || Type == TokenType.GreaterEqual || Type == TokenType.Less || Type == TokenType.LessEqual || Type == TokenType.StringEqual || Type == TokenType.Equal || Type == TokenType.Notequal; }
        }
        ...
        public bool IsAssignExpression {
            get { return Type == TokenType.DivAssign || Type == TokenType.MinusAssign || Type == TokenType.MultAssign || Type == TokenType.PlusAssign || Type == TokenType.PowAssign || Type == TokenType.Equal || Type == TokenType.ConcatAssign; }
        }
