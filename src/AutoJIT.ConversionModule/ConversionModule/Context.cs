...
namespace AutoJIT.CSharpConverter.ConversionModule
{
    internal sealed class Context : IContext
    {
        ...
        public Dictionary<string, Scope> VariableMap {
            get;
            set;
        }
        ...
        public string RuntimeInstanceName {
            get;
            private set;
        }
        public string ContextInstanceName {
            get;
            private set;
        }

        public IList<string> DeclaredVariables {
            get;
            set;
        }
        public IList<string> DeclaredGlobalVariables {
            get;
            set;
        }
        public IList<FieldDeclarationSyntax> FieldInstnaces {
            get;
            set;
        }
        public Dictionary<int, int> LoopLevelCount {
            get;
            set;
        }
        ...
        public Dictionary<int, int> SelectLevelCount {
            get;
            set;
        }
