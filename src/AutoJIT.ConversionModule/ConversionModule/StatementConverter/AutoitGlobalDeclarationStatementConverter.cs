...
namespace AutoJIT.CSharpConverter.ConversionModule.StatementConverter
{
    ...
    {
        public AutoitGlobalDeclarationStatementConverter( ICSharpStatementFactory cSharpStatementFactory, IInjectionService injectionService )
        ...
        private StatementSyntax AssignArray( GlobalDeclarationStatement statement, IContextService context ) {
            ...
            CSharpStatementFactory.CreateInvocationExpression(
                                                              ...
                                                              new CSharpParameterInfo( Convert( statement.InitExpression, context ), false ).ToEnumerable() )
                                  .ToStatementSyntax();
        }
        ...
        private StatementSyntax AssignVariable( GlobalDeclarationStatement node, IContextService context ) {
            ...
            SyntaxFactory.BinaryExpression(
                                           ...
                                           SyntaxFactory.IdentifierName( context.GetVariableName( node.VariableExpression.IdentifierName, Scope.Global ) ),
